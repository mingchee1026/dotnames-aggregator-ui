...
import SeiCheckoutFooter from "./SIDBnbCheckoutFooter";
import ENSCheckoutFooter from "./SIDBnbCheckoutFooter";
...
import SIDBnbCheckoutFooter from "./SIDBnbCheckoutFooter";
...
function SIDBnbCheckout({ list }: any) {
    ...
    <div className="border border-gray-400/40 p-5 rounded-lg h-full min-h-[70vh] my-5 lg:my-0">
      <div className="flex justify-between">
        <p className="capitalize text-xl">
          {SIDBNB_COIN_DENOM?.networkName} Network
        </p>
