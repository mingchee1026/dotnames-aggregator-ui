...
import SeiCheckoutFooter from "./SIDArbCheckoutFooter";
import ENSCheckoutFooter from "./SIDArbCheckoutFooter";
...
import SIDBnbCheckoutFooter from "./SIDArbCheckoutFooter";
...
function SIDArbCheckout({ list }: any) {
    ...
    <div className="border border-gray-400/40 p-5 rounded-lg h-full min-h-[70vh] my-5 lg:my-0">
      <div className="flex justify-between">
        <p className="capitalize text-xl">
          {SIDARB_COIN_DENOM?.networkName} Network
        </p>
      ...
      <SIDBnbCheckoutFooter />
    </div>
  );
}

export default SIDArbCheckout;
